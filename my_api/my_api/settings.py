...
ASGI_APPLICATION = 'my_api.asgi.application'
...
# Allow credentials if you are using cookies or authorization headers
CORS_ALLOW_CREDENTIALS = True

# Add trusted origins for CSRF protection if needed
